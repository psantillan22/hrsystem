                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                        <h1 class="flex-grow-1 fs-4 fw-semibold my-2 my-sm-3">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Item Master Data</li>
                            </ol>
                        </h1>
                    </div>
                </h3>
...
@include('file-maintenance.item-data.modals.item-master')

@push('scripts')
    <script src="{{ url('/assets/js/functions/file-maintenance/item-data/item-master.js') }}"></script>
@endpush
