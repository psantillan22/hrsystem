        ...
        <div class="content">
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    ...
                    <table id ="subclassificationTable"
...
@include('file-maintenance.item-data.modals.sub-classification')

@push('scripts')
    <script src="{{ url('/assets/js/functions/file-maintenance/item-data/sub-classification.js') }}"></script>
@endpush
