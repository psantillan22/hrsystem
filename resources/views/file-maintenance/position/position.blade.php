@extends('layout')
@section('title', 'File Maintenance - Position')
...
@include('file-maintenance.position.modals.position')

@push('scripts')
    <script src="{{ url('/assets/js/functions/file-maintenance/position/position.js') }}"></script>
@endpush
