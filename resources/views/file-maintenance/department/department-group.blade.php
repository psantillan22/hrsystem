...
@include('file-maintenance.department.modals.department-group')

@push('scripts')
    <script src="{{ url('/assets/js/functions/file-maintenance/department/department-group.js') }}"></script>
@endpush
